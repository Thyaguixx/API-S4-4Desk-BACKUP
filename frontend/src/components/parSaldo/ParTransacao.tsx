        ...
        <Box sx={{ flexGrow: 1, marginLeft: "0%", marginTop: "-6%" }}>
          <Grid container spacing={2}>
            <Grid item xs={6} md={10}>
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label="Estabelecimento que deseja comprar óleo"
                  />
                )}
              />
            </Grid>
            ...
            <Grid item xs={6} md={5}>
              ...
              >
                <ListItem disablePadding>
                  <ListItemText
                    ...
                    sx={{mt:"-3%"}}
                  />
                  <div style={{ width:"400px", marginLeft:"-15%", marginTop:"0%"}}>
                  <ListItemText
                    inset
              ...
              <div style={{ display: "flex", alignItems: "center", marginLeft:"-40%", marginTop:"-11%" }}>
